...
private:
	void RenderScreenQuad(const u32 w, const u32 h, ID3DRenderTargetView* rt, ref_selement& sh, std::map<LPCSTR, Fvector4*>* consts = nullptr);
	void RenderScreenQuad(const u32 w, const u32 h, ref_rt& rt, ref_selement& sh, std::map<LPCSTR, Fvector4*>* consts = nullptr);
